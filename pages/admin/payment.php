...
<a href="./dashboard"><div class='listWizard'>Dashboard</div></a>
    ...
    <a href="./payment"><div class='listWizard' aktif='ya'>Payments</div></a>
...
<div class='container'>
    <div class='wrap'>
        <h4><div id="icon"><i class="fa fa-money"></i></div> Payment</h4>
        <div id='load'></div>
    </div>
</div>
...
<script>
    function load() {
        ambil("../aksi/booking/all.php", (res) => {
            tulis("#load", res)
        })
    }

    function cawang(val) {
        pos("../aksi/booking/cawang.php", "id="+val, () => {
            load()
        })
    }
